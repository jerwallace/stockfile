...
/**
 * The DNS Resolver sends a UDP packet to the StockFile Gateway, which
 * determines the current live server. It can give the IP address of three
 * servers, the current master, the instances slave or the localhost.
 *
...
public class DNSResolver {
     ...
     *
     * @param type The type of server address to receive, MASTER, SLAVE OR
     * LOCAL_HOST
     ...
     * @throws ApplicationFailedException If the gateway is down or all servers
     * are down.
     */
